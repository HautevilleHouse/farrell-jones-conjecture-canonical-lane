# Reviewer Map
    ...
    6. Scalar closure: `FJ_G1, FJ_G2, FJ_G3, FJ_G4, FJ_G5, FJ_G6, FJ_GM` all `PASS`.

    Primary files:

    - `paper/FARRELL_JONES_CONJECTURE_PREPRINT.md`
    - `notes/EG1_public.md`
    - `notes/EG2_public.md`
    - `notes/EG3_public.md`
    - `notes/EG4_public.md`
...
| `FJ_G6` | `eps_coh` | strict coherence / identification closure |
| `FJ_GM` | derived | final strict margin |
