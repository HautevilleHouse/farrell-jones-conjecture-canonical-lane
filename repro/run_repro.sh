...
mkdir -p .repro_tmp/farrell_jones_conjecture
cp artifacts/stitch_constants.json .repro_tmp/farrell_jones_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/farrell_jones_conjecture/constants_registry.json
